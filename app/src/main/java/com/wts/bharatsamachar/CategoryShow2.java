...
public class CategoryShow2 extends AdsAppCompactActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        liveTV_Img.setOnClickListener(v -> startActivity(new Intent(CategoryShow2.this,LiveTV.class)));

        searchImg.setOnClickListener(v -> {
            Intent intent = new Intent(CategoryShow2.this,SearchNewsList.class);
            startActivity(intent);
        });
        mainLogo_Img = findViewById(R.id.mainLogo_Img);
        mainLogo_Img.setOnClickListener(v -> {
            Intent intent = new Intent(CategoryShow2.this,MainActivity.class);
            startActivity(intent);
        });
    ...
    private void getNewListData() {
        arrayList.clear();
        ProgressDialog progressDialog = new ProgressDialog(CategoryShow2.this);
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                try {
                    ...
                    if (status.equalsIgnoreCase("success")) {
                        ...
                        NewListAdapter adapter = new NewListAdapter(CategoryShow2.this, arrayList);
                        recyclerView.setLayoutManager(new LinearLayoutManager(CategoryShow2.this, RecyclerView.VERTICAL, false));
                        recyclerView.setAdapter(adapter);
                        adapter.notifyDataSetChanged();
                        progressDialog.dismiss();
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(CategoryShow2.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    progressDialog.dismiss();
